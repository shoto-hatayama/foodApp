...
<div class="container">
  <form id="modal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <button type="submit" name="deleteSubmit" class="btn btn-danger col-md-2 offset-md-4 mt-2" id="deleteSubmit">削除</button>
          <button type="submit" name="editSubmit" class="btn btn-success col-md-2 col-md-offset-1 mt-2">登録</button>
